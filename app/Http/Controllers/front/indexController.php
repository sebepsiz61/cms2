...
class indexController extends Controller
{
     public function index()
    {
        ...
        $setting = Setting::where('email','asc')->orderBy('phone', 'asc')->get();
    ...
    public function sitemap()
    {
        ...
        $service = LanguageContent::where('languageId',$languageId)->where('chapter',SERVICE_LANGUAGE)->where('chapterSub',SLUG_LANGUAGE)->get();
